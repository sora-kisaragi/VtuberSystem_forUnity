...
namespace Unity.Labs.FacialRemote
{
    ...
    public class CharacterRigController : MonoBehaviour, IUsesStreamReader
    {
        ...
        //Quaternion m_BackwardRot = Quaternion.Euler(0, 0, 0);
        ...
        public void InterpolateBlendShapes(bool force = false)
        {
            ...
            if (force || streamReader.trackingActive)
            {
                ...
                // ここをいじくり回すと最終的な軸が変更されるよ！あとでミラーと正しい軸を作ろう
                var headRot = new Quaternion(
                    -m_LocalizedHeadRot.localRotation.y, 
                    -m_LocalizedHeadRot.localRotation.z, 
                     m_LocalizedHeadRot.localRotation.x,
                     m_LocalizedHeadRot.localRotation.w);

                //var headRot = new Quaternion(m_LocalizedHeadRot.localRotation.z, m_LocalizedHeadRot.localRotation.x, m_LocalizedHeadRot.localRotation.y, m_LocalizedHeadRot.localRotation.w);
        ...
        void LocalizeFacePose()
        {
            ...
            //m_LocalizedHeadRot.rotation = new Vector3(headPose.rotation.x);
        ...
        void UpdateBoneTransforms()
        {
            ...
            if (m_DriveHead)
                ...
                //m_HeadBone.eulerAngles = new Vector3(m_ARHeadPose.eulerAngles.z, m_ARHeadPose.eulerAngles.x, m_ARHeadPose.eulerAngles.y);
